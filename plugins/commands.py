...
async def help(client, message):
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("How to Deploy?", url="https://t.me/worldmoviesaj"),
                    InlineKeyboardButton("About Me",url="https://t.me/worldmoviesaj")
                ],
                [
                    InlineKeyboardButton("BOT Channel", url="https://t.me/AJmovieLINKS"),
                    InlineKeyboardButton("Support Group", url="https://t.me/worldmoviesaj")
                ]
            ]
        ),
        reply_to_message_id=message.message_id
            ...
            [
                [
                    InlineKeyboardButton(
                        "SOURCE CODE", url="https://t.me/worldmoviesaj")
                ],
                [
